...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        override func viewDidDisappear(_ animated: Bool) {
            ...
            /*Este metodo se llama cuando la vista es removida de pantalla. Buen lugar para detener procesos que no se requieran cuando el usuario no ve esa pantalla que fue removida. Ejemplo: Detener musica, llamadas a servidores o a dispositivos externos ligados a esa vista */
            print("Estoy en VC1 y se activo -> \(#function)")
        }
